...
function UpdateNews() {
  ...
  const fetchNews = async () => {
    try {
      const res = await axios.get(`https://full-booking-2.onrender.com/readSingle/New/${id}`);
      ...
      setPreview(`https://full-booking-2.onrender.com/allImages/${news.img}`); 
    } catch (err) {
      console.error(err);
    }
  };
...
o
      ...
      await axios.put(`https://full-booking-2.onrender.com/update/new/${id}`, formData, {
