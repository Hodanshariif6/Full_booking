...
function ForgotPassword() {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://full-booking-2.onrender.com/forgot-password", { email });
  ...
  const handleResetSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://full-booking-2.onrender.com/reset-password", { 
        token: token.trim(), 
        newPassword 
      });
